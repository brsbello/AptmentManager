package com.example.aptmentmanager.warnings.adapter
...
class WarningAdapter : ListAdapter<WarningModel, WarningAdapter.WarningViewHolder>(DiffCallback()) {
    ...
    inner class WarningViewHolder(private val binding:ItemWarningBinding) : RecyclerView.ViewHolder(binding.root){
...
class DiffCallback : DiffUtil.ItemCallback<WarningModel>(){
    ...
    override fun areContentsTheSame(oldItem: WarningModel, newItem: WarningModel) = oldItem.id == newItem.id
